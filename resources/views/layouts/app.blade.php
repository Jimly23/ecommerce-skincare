            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    <form action="{{ route('shop.index') }}" method="GET" class="relative">
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari produk..." class="w-48 pl-10 pr-4 py-2 rounded-full border border-rose-200 bg-rose-50 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400 focus:border-transparent transition-all placeholder-zinc-400">
                        <button type="submit" class="absolute left-3 top-2.5 text-zinc-400 hover:text-pink-500 focus:outline-none">
